...
<form action="freeBoard">
	...
	<c:forEach var="pageNo" begin="${pageResponse.startPage}" end="${pageResponse.endPage}">
		<a style="text-decoration: none; color: black;" href="freeBoard?pageNo=${pageNo}&size=${pageResponse.size}&searchValue=${pageResponse.searchValue}">
		<c:choose>
...
const searchValue = document.querySelector("#searchValue");
	size.addEventListener("change", e => {
		location = "freeBoard?pageNo=1&size=" + size.value + "&searchValue=" + searchValue.value;	
	});
